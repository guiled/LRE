...
export default class Component<T = LetsRole.ComponentValue>
  implements
    Omit<
      ...
      "on" | "off" | "find" | "value" | "sheet" | "parent" | "virtualValue" | "rawValue" | "text"
    >,
    ComponentCommon
{
  #realId: string;
  ...
  virtualValue(newValue?: LetsRole.ComponentValue): void | LetsRole.ComponentValue {
    throw new Error("Method not implemented.");
  }
...
/*#__PURE__*/ /*applyMixins(Component, [
